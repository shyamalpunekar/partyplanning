...
public class RestaurantTest {
    ...
    @Test
    public void getAddressReturnsCorrectName() throws Exception {
        Restaurant testRestaurant = setupRestaurant();
        assertEquals("214 NE Broadway", testRestaurant);
    }

    public Restaurant setupRestaurant() {
        return new Restaurant("Fish Witch", "214 NE Broadway", "97232", "503-402-9874", "http://fishwitch.com",
                "hellofishy@fishwitch.com", "fishwitch.jpg");
    }
    ...
    @Test
    public void setNameReturnsCorrectName() throws Exception {
        Restaurant testRestaurant = setupRestaurant();
    ...
    @Test
    public void setAddressReturnsCorrectAddress() throws Exception {
        Restaurant testRestaurant = setupRestaurant();
        testRestaurant.setAddress("6600 NE Ainsworth");
        assertNotEquals("214 NE Broadway",testRestaurant.getName());
    }
